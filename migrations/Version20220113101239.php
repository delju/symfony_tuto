 ...
 */
final class Version20220113101239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gallery (id INT AUTO_INCREMENT NOT NULL, advert_id INT NOT NULL, UNIQUE INDEX UNIQ_472B783AD07ECCB6 (advert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE gallery ADD CONSTRAINT FK_472B783AD07ECCB6 FOREIGN KEY (advert_id) REFERENCES advert (id)');
